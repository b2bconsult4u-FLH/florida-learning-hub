    ...
    for b in blocks:
        ...
        if b["kind"] == "p":
            ...
            if normalized.startswith("© 2026 Wm. E. McMullen"):
                continue
            if normalized.startswith("Copyright © 2026 Wm. E. McMullen"):
                continue
            if normalized in {"Published by Florida Learning Hub", "FloridaLearningHub.org"}:
                continue
        cleaned.append(b)
    return cleaned
